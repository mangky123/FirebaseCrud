...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_environment__ = __webpack_require__(241);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, alertCtrl) {
        ...
        this.items = [];
        this.ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('items/');
        this.inputText = '';
        this.ref.on('value', function (Response) {
            _this.items = Object(__WEBPACK_IMPORTED_MODULE_3__app_environment__["b" /* snapshotToArray */])(Response);
        });
    }
    ...
    HomePage.prototype.delItem = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('items/' + key).remove();
                return [2 /*return*/];
            });
        });
    };
    HomePage.prototype.editItem = function (key) {
                ...
                },
                {
                    ...
                    handler: function (data) {
                        if (data.name !== undefined && data.name.length > 0) {
                            __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('items/' + key).update({ name: data.name });
                        }
                    }
                }
            ]
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\ScificeAceZ\Desktop\firedb\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label >Name</ion-label>\n    <ion-input type="text" [(ngModel)]="inputText" placeholder="Item Name"></ion-input>\n  </ion-item>\n  <button ion-button block (click)="addItem({name:inputText})">Add</button>\n  <ion-list>\n    <ion-item *ngFor="let item of items" (click)="editItem(item.key)">\n      {{ item.name }}\n      <button ion-button style="float:right" (click)="delItem(item.key)">Del</button>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\ScificeAceZ\Desktop\firedb\src\pages\home\home.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__environment__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_home_home__ = __webpack_require__(242);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_firebase__["initializeApp"](__WEBPACK_IMPORTED_MODULE_5__environment__["a" /* FIREBASE_CONFIG */]);
    }
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\ScificeAceZ\Desktop\firedb\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\ScificeAceZ\Desktop\firedb\src\app\app.html"*/
        }),
